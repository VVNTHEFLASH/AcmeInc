...
import TransactionListCard from './Dashboard/Main/Cards/TransactionListCard';
...
const AllTransactions = () => {
  ...
  return (
    ...
    <div>
        ...
        <div>
            {data.map((item: any, index: number) => <TransactionListCard key={index} data={item} index={index} />)}
        </div>
    </div>
    </>
  )
